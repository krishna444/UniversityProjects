...
public class ProductListBean {
     ...
     */
    public ArrayList getComponents(int productId)
            throws Exception, SQLException {
        ArrayList componentList = new ArrayList();
        String query = "SELECT a.comp_id,a.name,a.rate,a.quantity,a.description "
                + "FROM components a INNER JOIN mapping b ON a.comp_id=b.comp_id WHERE b.product_id='" + productId + "'";
        ResultSet resultSet = this.connection.ExecuteQuery(query);
        while (resultSet.next()) {
