    ...
    public int doEndTag() throws JspException {
        try {
            ...
            while (iterator.hasNext()) {
                ...
                out.print("<shoppingitem>"); builder.append("<shoppingcart>");
                out.print(product.getXml());builder.append(product.getXml());
                out.print("<quantity>");builder.append("<quantity>");
                out.print(quantity); builder.append(quantity);
                out.print("</quantity>");builder.append("</quantity>");
                out.print("<cost>");  builder.append("<cost>");
                out.print(String.valueOf(totalCost)); builder.append(String.valueOf(totalCost));
                out.print("</cost>"); builder.append("</cost>");
                out.print("</shoppingitem>");builder.append("</shoppingcart>");
            }
        } catch (Exception ex) {
