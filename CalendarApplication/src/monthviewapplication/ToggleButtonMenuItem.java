...
class ToggleButtonMenuItem extends JToggleButton implements MenuElement {
  Color savedForeground = null;

  private static MenuElement NO_SUB_ELEMENTS[] = new MenuElement[0];

  public ToggleButtonMenuItem(String label) {
    super(label);
    super.setBorderPainted(false);
    init();
  }

  public ToggleButtonMenuItem(String label, String imgpath){
      super(label,new ImageIcon(imgpath));
      super.setBorderPainted(false);
      init();
  }
  private void init() {
