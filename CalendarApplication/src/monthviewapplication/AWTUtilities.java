...
/**
 * Modified the code written by Anthony Petrov
 * It is the wrapper class to set transparency other graphic related operations
 * Note: Not all platforms support the methods specified here.
 * So, some careful is needed before using this class
 * @author Krishna
 */
