 ...
 * @author Rupesh
 */
public class CalendarEventAddEditActionNew<T> extends TodoManagerAction {

    private Repository<CalendarEvent> repository;
    private TaskView userInterface;
     ...
     */
    public CalendarEventAddEditActionNew(String name, ImageIcon icon, String toolTipText,
                    TaskView taskView,Repository<CalendarEvent> repo){
        super(name, icon);
        putValue(Action.SHORT_DESCRIPTION, toolTipText);
        //putValue(Action.MNEMONIC_KEY, mnemonic);
        userInterface = taskView;
        repository = repo;
    }
    ...
    public void actionPerformed(ActionEvent e){
        ...
        CustomDate beginDate = dateController.extractDate(userInterface.getBeginCalendar());
        CustomDate endDate = dateController.extractDate(userInterface.getEndCalendar());
        /**
